...
import FieldsetControlMain from '../controls/FieldsetControl';
...
class FieldsetControl extends Component {
	...
	addControl(data, idx) {
		...
		switch (innertype) {
			...
			case 'fieldset':
				return (<FieldsetControlMain index={idx} data={data} type={type} onChange={this.addClick} mode={this.state.mode} close={this.handleCloseModal} values={this.state.fields} />);
			case 'heading':
			...
			case 'panel':
				return (<PanelControl index={idx} data={data} type={type} onChange={this.addClick} mode={this.state.mode} close={this.handleCloseModal} values={this.state.fields} />);
			case 'password':
